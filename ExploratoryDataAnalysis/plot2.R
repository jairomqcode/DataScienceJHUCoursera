...
# generar un gráfico de potencia activa global vs tiempo.
################################################################################
...
# Paso 4: Gráfico.
#
# la función plot() es usada de manera general para crear gráficos. Esta función
# tiene un comportamiento especial, pues dependiendo del tipo de dato que le demos
# como argumento, generará diferentes tipos de gráfica.
#
# xlab: etiqueta para el eje x.
# ylab: etiqueta para el eje y.

plot(dato$Global_active_power~data$Datetime, type="l",
     ylab="Global Active Power (kilowatts)", xlab="")
################################################################################
# Paso 5: Guardando Archivos.
#
